...
public class GoogleAD_LoadingScene : MonoBehaviour
{
    ...
    {
        string _adUnitId = GoogleAdManager.I.master.googleAdSettings.GetUnitID(GoogleAdManager.I.master.gameMode, GoogleAdSettings.AdType.LoadingScene);
    ...
    {
        // IsPlayAd��false�ɂȂ�܂Ń��[�v���܂��B
        while (IsPlayAd)
        {
            // ���̃t���[���܂őҋ@���܂��B
            await Task.Delay(100); // �����ł�100�~���b�҂��Ƃɂ��܂����A�C�ӂ̒l�ɒ����\�ł��B
        }
    }
